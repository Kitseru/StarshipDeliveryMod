...
internal class StarshipReplacement : MonoBehaviour
{
    public static void ReplaceStarshipModel(GameObject _dropShip)
    {
        ...
        newShipObject.transform.localPosition = new Vector3(0, 0, 0);
        ...
        spawnPositions[0].localPosition = new Vector3(4.960f,1.185f, 1.352f);
        spawnPositions[1].localPosition = new Vector3(5.140f,0.509f, 1.352f);
        spawnPositions[2].localPosition = new Vector3(5.177f,-0.374f, 1.352f);
        spawnPositions[3].localPosition = new Vector3(5.058f,-1.069f, 1.352f);
        ...
        //Change size according to config file
        float newScale = _dropShip.transform.localScale.x * (ConfigSettings.starshipSize.Value / 100);
        _dropShip.transform.localScale = new Vector3(newScale, newScale, newScale);
        StarshipDelivery.mls.LogInfo(">>> Ship size set to " + ConfigSettings.starshipSize.Value.ToString() + "%");
